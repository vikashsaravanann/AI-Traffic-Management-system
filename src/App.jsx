    ...
    <div className="h-screen w-screen flex flex-col bg-background overflow-hidden relative selection:bg-primary/20 font-sans text-white">
      ...
      <main className="flex-1 grid grid-cols-12 gap-6 p-6 min-h-0">
        ...
        <div className="col-span-9 flex flex-col gap-6 min-h-0">
            ...
            {/* Bottom Panel: Source & Build Info */}
            <div className="h-24 grid grid-cols-2 gap-6 shrink-0">
                <div className="glass-panel p-6 flex items-center justify-between border-white/5 bg-linear-to-r from-primary/5 to-transparent">
                    <div className="flex items-center gap-4">
                        <div className="bg-primary/20 p-2 rounded-lg">
                            <MonitorPlay className="w-5 h-5 text-primary" />
                        </div>
                        <div>
                            <h3 className="text-xs font-black uppercase tracking-widest text-white/80">Autonomous Command Center</h3>
                            <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest">Neural Stream Processed · v4.2.0</p>
                        </div>
                    </div>
                </div>
                
                <div className="glass-panel p-6 flex items-center justify-between border-white/5 bg-linear-to-l from-white/5 to-transparent">
                    <div className="flex items-center gap-3">
                        <Car className="w-5 h-5 text-gray-500" />
                        <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-tight">Yudhisthra Expert<br/><span className="text-[8px] opacity-40">Build 2026.04.1.0</span></span>
                    </div>
                    <a 
                      href="https://github.com/vikashsaravanann/AI-Traffic-Management-system"
                      target="_blank"
                      className="btn-primary px-6 py-2 text-[10px] font-black uppercase tracking-[0.2em]"
                    >
                      Repository Access →
                    </a>
                </div>
